...
<style>
    * {
    ...
    .profile-icon {
        width: 56px;
        height: 56px;
        background: linear-gradient(135deg, #3b82f6 0%, #1e58af 100%);
        border-radius: 50%;
        display: flex;
        align-items: center;
    ...
    .badge-usulan {
        background: linear-gradient(135deg, #06b5d4c3 0%, #08b265 100%);
        color: white;
    }
    ...
    .submit-btn {
        padding: 16px 48px;
        background: linear-gradient(135deg, #248d66ce 0%, #059669 100%);
        color: white;
        border: none;
        border-radius: 12px;
        font-size: 16px;
...
<div class="sidang-container">
    <div class="page-header">
        <h1 class="page-title">Sidang Komite Integritas</h1>
    ...
    <div class="view-berkas-section">
        <a href="{{ route('comite.pengajuan.view', ['id' => $pengajuan->id]) }}" class="view-berkas-btn">
    ...
    <!-- Form Card -->
    <div class="form-card">
        <form method="POST" action="{{ route('action.sidang.komite', ['pengajuanId' => $pengajuan->id]) }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-section">
                ...
                <input type="hidden" name="sidang" value="KOMITE">
            </div>
