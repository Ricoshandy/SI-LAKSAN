                    ...
                    <tr class="data-row">
                        ...
                        <td class="text-center">
                            <div class="action-buttons">
                                <a href="{{ route('comite.pengajuan.detail', ['id' => $pengajuan->id]) }}" title="Lihat Detail" class="action-btn btn-view">
                                ...
                                @if ($pengajuan->tahap == 'SIDANG_KOMITE' && $pengajuan->status != 'DITOLAK')
                                    <a href="{{ route('comite.pengajuan.view', ['id' => $pengajuan->id]) }}" title="Lihat Berkas Sidang" class="action-btn btn-upload">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
