...
<style>
    ...
    .timeline-date { font-size: 12px; color: #9ca3af; margin-bottom: 4px; }
    ...
    .timeline-tahap { font-size: 13px; font-weight: 600; color: #374151; margin-bottom: 4px; }
    .timeline-keterangan { font-size: 13px; color: #6b7280; }
    .timeline-by { font-size: 11px; color: #9ca3af; margin-top: 4px; }
...
{{-- copy semua CSS dari Comite/ViewPengajuanDetail atau sidebar sudah include --}}
...
<div class="content-wrapper">
    ...
    <div style="margin-bottom: 16px; display: flex; justify-content: flex-end;">
        <a href="{{ route('senat.pengajuan.download', ['id' => $pengajuan->id]) }}"
        ...
        <div class="file-review-item">
            <div class="file-header">
                ...
                @if ($pengajuan->$column !== null)
                    <button type="button" onclick="showModal('{{ route('senat.pengajuan.file', [
                        'id'  => $pengajuan->id,
                        'key' => $detail->key
                    ...
                    <a href="{{ route('senat.pengajuan.file', ['id' => $pengajuan->id, 'key' => $detail->key]) }}"
